...
//	$companyInfo2 = $companyInfo1->fetch_assoc();
    ...
    if ($query->num_rows > 0) {
        ...
        while ($result = $query->fetch_assoc()) {
            ...
            $receiptContent .= "<tr style='text-align: left;'><td style='width: 10%;'>$no</td><td style='width: 30%;'>".$result["product_name"]."</td><td style='width: 20%;'>".$result["quantity"]."</td><td style='width: 20%; text-align: right'>".number_format($result["total"], 2)."</td></tr>";
