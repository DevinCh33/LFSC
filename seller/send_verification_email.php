...
<body>
  <div style="font-family: Arial, sans-serif; color: #333;">
    ...
    <p><a href="http://lfsc.shop/seller/verify_email.php?token={$token}" style="background-color: #0046be; color: #ffffff; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-weight: bold;">Confirm Email Address</a></p>
    ...
    <p><a href="http://lfsc.shop/seller/verify_email.php?token={$token}" style="color: #0046be;">http://lfsc.shop/seller/verify_email.php?token={$token}</a></p>
