                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
											...
											if($_SESSION['adm_co'] == "SUPA")
												...
												$sql = "SELECT DISTINCT user_id FROM orders JOIN users ON orders.user_id = users.u_id WHERE status < 3 AND order_status < 3 AND order_belong = '".$_SESSION['store']."' ORDER BY order_status DESC";
